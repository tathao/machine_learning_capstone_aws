...
def train(model, train_loader, criterion, optimizer, device, hook ,epoch, checkpoint_dir):
    '''
...
def main(args):
    ...
    for epoch in range(start_epoch + 1, args.num_epochs+1):
        model = train(model, train_loader, loss_criterion, optimizer, device,hook, epoch, checkpoint_dir)
